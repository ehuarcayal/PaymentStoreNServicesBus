...
namespace Transactions.NSBEndpoint
{
    class Program
    {
        static async Task Main()
        {
            ...
            var endPointName = "Payments.NSBEndpoint";
            ...
            string mysqlConnectionString = Environment.GetEnvironmentVariable("MYSQL_STRCON_CORE_PAYMENTS");
            ...
            routing.RouteToEndpoint(typeof(CreditCards.Messages.Commands.WithdrawMoneyCommand).Assembly, "CreditCards.NSBEndpoint");
            routing.RouteToEndpoint(typeof(RejectCreditCardCommand), "Payments.NSBEndpoint");
        ...
        {
            string connectionString = Environment.GetEnvironmentVariable("MYSQL_STRCON_CORE_PAYMENTS");
